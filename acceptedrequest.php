...
$login_uid=$row['id'];
include('connection.php');
$sql="select * from reg inner join request on reg.id=request.reqby where request.reqto='$login_uid' and status='accepted'";
$res=mysql_query($sql);
...
<div class="col-sm-3">
	...
	<a href="#" class="btn btn-success" ><?php echo $row['mobile'];?></a>  <p>
	</div>
</div>
<?php
}
