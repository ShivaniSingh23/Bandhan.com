...
<div class="col-sm-12 sections11"> <span  style="color:green"> TEAM MEMBERS</span>
</div>
...
<div class="col-sm-4">
<div class="col-sm-12">
<img src="images/shivani.jpg" class="img-responsive" style="border:1px solid lightgray;padding:3px;min-height:200px;"></div>

	<div class="col-sm-12" style="min-height:50px;background:#eb2e4a;margin-bottom:10px;color:white;text-align:center;font-size:15px;"><div class="col-sm-1"></div>
<div class="col-sm-10">	Shivani Singh<br>(B.Tech 2nd year)<br>
	HITM,AGRA</div>
	<div class="col-sm-1"></div>
	</div></div>
...
<div class="col-sm-4">
<div class="col-sm-12">
<img src="images/.jpg" class="img-responsive" style="border:1px solid lightgray;padding:3px;min-height:200px;">
</div>
<div class="col-sm-12" style="min-height:50px;background:#eb2e4a;margin-bottom:10px;color:white;text-align:center;font-size:15px;"><div class="col-sm-1"></div>
<div class="col-sm-10">	Jyoti Yadav<br>(Diploma 2nd year)<br>
	</div>
	<div class="col-sm-1"></div>
	</div></div>
...
<img src="images/.jpg" class="img-responsive" style="border:1px solid lightgray;padding:3px;min-height:200px;">
<div class="col-sm-12" style="min-height:50px;background:#eb2e4a;margin-bottom:10px;color:white;text-align:center;font-size:15px;"><div class="col-sm-1"></div>
<div class="col-sm-10">Prashi Singh<br>(Diploma 2nd year)<br>
	</div>
	<div class="col-sm-1"></div>
	</div></div>
...
<img src="images/.jpg" class="img-responsive" style="border:1px solid lightgray;padding:3px;min-height:200px;">
<div class="col-sm-12" style="min-height:50px;background:#eb2e4a;margin-bottom:10px;color:white;text-align:center;font-size:15px;"><div class="col-sm-1"></div>
<div class="col-sm-10">	Neha<br>(Diploma 2nd year)<br>
	</div>
	<div class="col-sm-1"></div>
	</div></div>
...
<div class="col-sm-4" style="margin-top:2%;">
<div class="col-sm-12">
<img src="images/pri.jpg" class="img-responsive" style="border:1px solid lightgray;padding:3px;min-height:200px;">
<div class="col-sm-12" style="min-height:50px;background:#eb2e4a;margin-bottom:10px;color:white;text-align:center;font-size:15px;"><div class="col-sm-1"></div>
<div class="col-sm-10">Priyanka Chauhan<br>(Diploma 2nd year)<br>
	</div>
	<div class="col-sm-1"></div>
	</div></div>
